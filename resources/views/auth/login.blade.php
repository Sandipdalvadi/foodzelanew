...
<head>
    ...
    <title>Cuba - Premium Admin Template Login</title>
    <!-- Google font-->
                        ...
                        <div class="login-main">
                            <form class="theme-form" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="email" type="email" required="" placeholder="Test@gmail.com" name="email" value="{{ old('email') }}" >
