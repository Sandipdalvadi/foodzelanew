                                        ...
                                        <div class="row">
                                            <div class="col-md-3" style="">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select class="mb-4 form-control js-example-basic-single" onchange="driversDatatable()" name="status" id="selectStatus">
                                            ...
                                            <div class="col-md-9 text-right">
                                                <a style="color: white" class="mb-4 btn btn-danger deletesellected" onclick='multipleDelete("{{route("admin.drivers.alldelete")}}")'> <i class="fa fa-trash" aria-hidden="true"></i>Delete </a>
                                            </div>
                                        </div>
