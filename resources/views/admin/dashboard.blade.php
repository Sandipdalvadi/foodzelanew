              ...
              <div class="card o-hidden profile-greeting">
                <div class="card-body">
                  ...
                  <div class="greeting-user text-center">
                    <div class="profile-vector"><img class="img-fluid" src="{{asset('public/assets/images/dashboard/welcome.png')}}" alt=""></div>
                      ...
                      <div class="appointment-table table-responsive">
                        <table class="table table-bordernone">
                          <tbody>
                            <tr>
                              <td>
                                <img class="img-fluid img-40 rounded-circle mb-3" src="{{asset('public/assets/images/appointment/app-ent.jpg')}}" alt="Image description">
                            ...
                            <tr>
                              <td>
                                <img class="img-fluid img-40 rounded-circle" src="{{asset('public/assets/images/appointment/app-ent.jpg')}}" alt="Image description">
                                <div class="status-circle bg-primary"></div>
                              </td>
                  ...
                  <div class="media">
                    <div class="media-body">
                      <div class="d-flex mb-3">
                        <div class="inner-img"><img class="img-fluid" src="{{asset('public/assets/images/notification/1.jpg')}}" alt="Product-1"></div>
                        <div class="inner-img"><img class="img-fluid" src="{{asset('public/assets/images/notification/2.jpg')}}" alt="Product-2"></div>
                      </div>
                  ...
                  <div class="chat">
                    <div class="media left-side-chat">
                      <div class="media-body d-flex">
                        <div class="img-profile"> <img class="img-fluid" src="{{asset('public/assets/images/user.jpg')}}" alt="Profile"></div>
                        <div class="main-chat">
