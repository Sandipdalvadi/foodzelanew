    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h3>{{ __('message.restaurent_owners_detail') }}</h3>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.restaurent_owners.index') }}"> {{ __('message.restaurent_owners') }}</a>
                            </li>
                            <li class="breadcrumb-item">{{ __('message.restaurent_owners_detail') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 box-col-6">
                    <div class="card custom-card">
                        ...
                        <div class="text-center profile-details mt-3">
                            <b class="mb-1 d-block">{{ __('message.restaurent_owner_id') }}: {{ $user->id }}</b>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="card text-right">
                                        <a class="btn btn-success btn-sm" href="{{route('admin.restaurent_owners.index')}}">{{ __('message.back') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
