...
<link rel="stylesheet" type="text/css" href="{{asset('/public/assets/css/toggle_menu.css')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{ __('message.restaurent_owners') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3" style="">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select class="mb-4 form-control js-example-basic-single" onchange="restaurentODatatable()" name="status" id="selectStatus">
                                            ...
                                            <div class="col-md-9 text-right">
                                                <a style="color: white" class="mb-4 btn btn-danger deletesellected" onclick='multipleDelete("{{route("admin.restaurent_owners.alldelete")}}")'> <i class="fa fa-trash mr-2" aria-hidden="true"></i>Delete </a>
                                            </div> 
                                        </div>
    ...
    <script type="text/javascript">
        ...
        {
            restaurentODatatable();
            
        });
        function restaurentODatatable(){
            ...
            $('#example').DataTable({
                ...
                "rowId": 'id',
                "ajax":{
                    "url": "{{ route('admin.restaurent_owners.list') }}",
                    "dataType": "json",
                    "type": "POST",
